...
| 9. Final compliance and fresh-eyes review | in progress | All criteria | Apache-2.0, architecture contracts, locked tests, Ruff, build, secret scanning, and the adversarial risk register | Preserve honest external blockers and collect remote certification evidence only under explicit authorization |
